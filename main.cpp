...
void init_create_zombies() {
	for (int i = 0; i < num_of_enemies; i++) {
		...
		int a = GRID_WIDTH / 2;
		int b = GRID_HEIGHT / 2;
		bool x_in_initial = GRID_WIDTH / 2 - INIT_TERRITORY_LENGTH < a&& a < GRID_WIDTH / 2 + INIT_TERRITORY_LENGTH;
		bool y_in_initial = GRID_HEIGHT / 2 - INIT_TERRITORY_LENGTH < b && b < GRID_HEIGHT / 2 + INIT_TERRITORY_LENGTH;
